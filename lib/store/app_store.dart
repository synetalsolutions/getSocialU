...
abstract class AppStoreBase with Store {
  ...
  bool showShop = false;
  @observable
  bool showGamiPress = false;

  @observable
  bool showLearnPress = false;
  ...
  @observable
  bool isGamiPressEnable = false;
  @action
  Future<void> setAdsVisibility(bool val) async {
    showAds = val;
    setValue(SharePreferencesKey.showAds, val);
  }

  @action
  Future<void> setBlogsVisibility(bool val) async {
    showBlogs = val;
    setValue(SharePreferencesKey.showBlogs, val);
  }

  @action
  Future<void> setSocialLoginVisibility(bool val) async {
    showSocialLogin = val;
    setValue(SharePreferencesKey.showSocialLogin, val);
  }

  @action
  Future<void> setShopVisibility(bool val) async {
    showShop = val;
    setValue(SharePreferencesKey.showShop, val);
  }

  @action
  Future<void> setGamiPressVisibility(bool val) async {
    showGamiPress = val;
    setValue(SharePreferencesKey.showGamiPress, val);
  }

  @action
  Future<void> setLearnPressVisibility(bool val) async {
    showLearnPress = val;
    setValue(SharePreferencesKey.showLearnPress, val);
  }

  @action
  Future<void> setMemberShipVisibility(bool val) async {
    showMemberShip = val;
    setValue(SharePreferencesKey.showMemberShip, val);
  }

  @action
  Future<void> setForumsVisibility(bool val) async {
    showForums = val;
    setValue(SharePreferencesKey.showForums, val);
  }
