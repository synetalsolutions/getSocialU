...
class PostModel {
  ...
  int? reactionCount;
  int? isPinned;
  List<ContentObject>? contentObject;
  ...
  factory PostModel.fromJson(Map<String, dynamic> json) {
    return PostModel(
      ...
      contentObject: json['content_object'] != null && json['content_object'].runtimeType == (List<dynamic>) ? (json['content_object'] as List).map((i) => ContentObject.fromJson(i)).toList() : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.contentObject != null) {
      data['content_object'] = this.contentObject!.map((v) => v.toJson()).toList();
    }
