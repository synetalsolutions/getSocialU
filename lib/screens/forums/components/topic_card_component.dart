    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    parseHtmlString(widget.topic.forumName.validate()),
                    style: secondaryTextStyle(),
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                  ).visible(widget.showForums).onTap(() {
                    ForumDetailScreen(
          ...
          12.height,
          Text(parseHtmlString(widget.topic.title.validate().validateAndFilter()), style: boldTextStyle()),
          Divider(height: 30),
          Row(
