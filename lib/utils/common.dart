...
void setRestrictions({String? levelId}) {
  restrictions(levelId: levelId).then((value) {
    pmpStore.setViewGroups(value.pmproBpGroupsPageViewing == 1);
    pmpStore.setViewSingleGroup(value.pmproBpGroupSingleViewing == 1);
    pmpStore.setCanCreateGroup(value.pmproBpGroupCreation == 1);
    pmpStore.setCanJoinGroup(value.pmproBpGroupsJoin == 1);
    pmpStore.setSendFriendRequest(value.pmproBpSendFriendRequest == 1);
    pmpStore.setSendFriendRequest(value.pmproBpSendFriendRequest == 1);
    pmpStore.setPrivateMessaging(value.pmproBpPrivateMessaging == 1);
    pmpStore.setMemberDirectory(value.pmproBpMemberDirectory == 1);
  }).catchError((e) {
